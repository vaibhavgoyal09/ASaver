            ...
            try {
                url?.let {
                    ...
                    if (sessionId != null && csrfToken != null && userid != null) {
                        prefManager.putString(COOKIES, cookies)
                        prefManager.putString(CSRF, csrfToken)
                        prefManager.putString(SESSION_ID, sessionId)
                        prefManager.putString(USER_ID, userid)
                        prefManager.putBoolean(IS_INSTA_LOGGED_IN, true)

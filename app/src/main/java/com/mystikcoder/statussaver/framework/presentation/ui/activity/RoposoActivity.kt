...
import com.mystikcoder.statussaver.framework.presentation.ui.viewmodel.RoposeViewModel
...
class RoposoActivity : AppCompatActivity() {
    ...
    private val viewModel: RoposeViewModel by viewModels()
    ...
    private fun initViews() {
        ...
        binding.imageAppLogo.setOnClickListener {
            startAnotherApp("com.roposo.android")
        }

...
package com.mystikcoder.statussaver.domain.videoconverter;
...
public class PlaylistDownloader {
    ...
    public PlaylistDownloader(String playlistUrl, Context context) throws MalformedURLException {
    ...
    private void downloadAfterCrypto() throws IOException {
        ...
        for (int i = 0; i < playlist.size(); i++) {
            ...
            if (line.startsWith(EXT_X_KEY)) {
                ...
                Log.e("Playlist downloader", segmentUrl.toString());
            }
        }
    ...
    private void startDownload(String downloadPath) {
        ...
        String fileName = "Josh" + System.currentTimeMillis() + ".mp4";

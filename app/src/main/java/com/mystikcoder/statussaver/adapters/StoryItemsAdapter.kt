...
class StoryItemsAdapter(
    ...
    private val instaStories: ArrayList<ItemModel>?,
    private val itemsToBind: String,
    private val facebookStories: ArrayList<FacebookNode>?
) :
            ...
            binding.buttonDownload.setOnClickListener {
                if (Utils.isNetworkAvailable(context)) {
                    if (Utils.hasWritePermission(context)) {
                        ...
                        Utils.createToast(context, "Require storage permission")
                    }
                } else {
                    Utils.createToast(context, "No Internet connection available")
                }
            }
        }
